...
//Open Library covers 
// async function fetchImage(url = 'https://covers.openlibrary.org/b/id/12547191.json' ) {
  
//   const img = new Image("https://covers.openlibrary.org/b/isbn/"+ isbn +".jpg");
...
function updateCover(id, isbn) {
  fetch('https://www.googleapis.com/books/v1/volumes?q=isbn:' + isbn + "&key=AIzaSyCM6gNVwBQzpE0dVOcGE_aZqb_-_xd4NDA" , {
    method: 'get'
  })
  .then(response => { return response.json(); })
  .then(data => {
